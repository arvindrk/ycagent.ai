...
<div className="bg-bg-primary">          {/* Page */}
  <Card className="bg-bg-secondary">      {/* Card */}
    <div className="bg-bg-tertiary">      {/* Nested */}
      Content
    </div>
  </Card>
</div>
...
// Active state (Linear pattern)
className="active:scale-[0.97] transition-fast"

// Combined
className="hover:bg-accent-hover active:scale-[0.97] transition-base"
```
...
<div className="min-h-screen bg-bg-primary">
  ...
  <Card className="bg-bg-secondary">
    ...
    <div className="bg-bg-tertiary rounded-md p-4">
      ...
      <div className="bg-bg-quaternary">
        Content
      </div>
    </div>
  </Card>
...
```tsx
<div>
  <h1 className="text-text-primary font-semibold">    {/* Primary heading */}
    Main Title
  </h1>
  <p className="text-text-secondary">                 {/* Secondary text */}
    Supporting description
  </p>
  <span className="text-text-tertiary text-sm">      {/* Tertiary/subtle */}
    Metadata
  </span>
</div>
```
...
<Button
  className="
    ...
    active:scale-[0.97]                     // Active (Linear pattern)
...
```tsx
{/* Success */}
<Badge className="bg-green/10 text-green border border-green/20">
  Active
</Badge>
...
{/* Error */}
<Badge className="bg-red/10 text-red border border-red/20">
  Failed
</Badge>
```
...
✅ Use the `active:scale-[0.97]` pattern for buttons
...
❌ Avoid skipping interaction states
❌ Don't mix design systems (no random Tailwind colors)
❌ Never omit focus states
❌ Don't use different scale transforms (stick to 0.97)
